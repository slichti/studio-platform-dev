...
type Module = typeof import("../studio.$slug.classes.$classId.live.js")

type Info = GetInfo<{
  file: "routes/studio.$slug.classes.$classId.live.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../studio.$slug.classes.$classId.live.js");
}];
