    ...
    return (
        <div className="max-w-5xl pb-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    {features?.has('progress_tracking') && (
                        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg p-5 shadow-sm">
                            ...
                            <p className="text-xs text-zinc-500 mb-3">Select your studio type to show relevant metrics.</p>
                            <form onSubmit={async (e) => {
                                e.preventDefault();
                                ...
                                try {
                                    ...
                                    toast.success("Studio type saved.");
                                    window.location.reload();
                                } catch (err: any) {
            ...
            <ConfirmationDialog
                ...
                message={chatToggle ? "Enable chat widget?" : "Disable chat widget?"}
