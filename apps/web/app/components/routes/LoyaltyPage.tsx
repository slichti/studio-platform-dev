...
import { useLoaderData, useActionData, Form, useOutletContext } from "react-router";
import { Award, Plus, Trash2, Target, Gift } from "lucide-react";
import { toast } from "sonner";
import { useState, useEffect } from "react";

export default function LoyaltyPage() {
    const { challenges, error } = useLoaderData<any>();
