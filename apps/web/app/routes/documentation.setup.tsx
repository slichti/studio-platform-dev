                ...
                <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="bg-green-50 dark:bg-green-900/10 p-3 rounded-lg border border-green-100 dark:border-green-800/50 mt-3">
                                <h4 className="font-bold text-sm text-green-800 dark:text-green-300 mb-1">Stripe Connect</h4>
                                <ul className="text-xs text-green-700 dark:text-green-400 space-y-1">
                                    <li>• Fast, secure payouts to your bank account</li>
                                    <li>• Accepts all major credit cards and Apple Pay</li>
                                    <li>• PCI-compliant security handled by Stripe</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <section className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 shadow-sm">
                    <div className="flex items-start gap-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <Link to="/documentation/mobile-builder" className="inline-flex items-center text-purple-600 hover:text-purple-700 font-medium">
