import{R as s,a as O,j as $,w as B,k as N,c as Y,r as V,M as f,q as h,O as q,S as J,s as v,l as W}from"./chunk-JMJ3UQ3L-Cjm2z498.js";import{j as e}from"./jsx-runtime-u17CrQMm.js";import{T as z}from"./ThemeProvider-DnRrqB0r.js";import{C as m}from"./index-B2F_-mkI.js";import"./chunk-VMBS36YX-BVvZBZKC.js";import"./chunk-OT5FTIRN-CTHvgDMh.js";import"./index-kQteDoUl.js";import"./index-ChdCOQ7E.js";import"./runtimeEnvironment-BB2sO-19-DQnzQjGy.js";import"./chunk-6WD75OPE-CvSmMgj3.js";import"./index-f3YqS9ZS.js";var i=r=>`🔒 Clerk: ${r.trim()}
...
`);function X(r){(!r||!r.__internal_clerk_state)&&console.warn(k)}function Z(r){if(!r)throw new Error(k);if(r&&!r.__internal_clerk_state)throw new Error(G)}function ee(r){if(!r||typeof r!="string")throw new Error(H)}var y=()=>{var r;if(typeof window<"u"&&typeof((r=window.__reactRouterContext)==null?void 0:r.isSpaMode)<"u")return window.__reactRouterContext.isSpaMode},w=s.createContext(void 0);w.displayName="ClerkReactRouterOptionsCtx";var re=r=>{const{children:t,options:o}=r;return s.createElement(w.Provider,{value:{value:o}},t)},te=()=>{const r=O(),t=$(),o=s.useRef([]),n=()=>{o.current.forEach(a=>a()),o.current.splice(0,o.current.length)};return s.useEffect(()=>{n()},[t]),(a,d)=>new Promise(u=>{o.current.push(u),r(a,d)})},oe={name:"@clerk/react-router",version:"2.3.9"},c={current:void 0};function ae({children:r,...t}){const o=te(),n=y();s.useEffect(()=>{c.current=o},[o]);const{clerkState:a,...d}=t;m.displayName="ReactClerkProvider",typeof n<"u"&&!n&&Z(a);const{__clerk_ssr_state:u,__publishableKey:x,__proxyUrl:b,__domain:R,__isSatellite:S,__clerk_debug:E,__signInUrl:U,__signUpUrl:C,__afterSignInUrl:j,__afterSignUpUrl:I,__signInForceRedirectUrl:P,__signUpForceRedirectUrl:A,__signInFallbackRedirectUrl:L,__signUpFallbackRedirectUrl:M,__clerkJSUrl:F,__clerkJSVersion:K,__telemetryDisabled:D,__telemetryDebug:T}=a?.__internal_clerk_state||{};s.useEffect(()=>{typeof n<"u"&&!n&&X(a)},[]),s.useEffect(()=>{window.__clerk_debug=E},[]);const g={publishableKey:x,proxyUrl:b,domain:R,isSatellite:S,signInUrl:U,signUpUrl:C,afterSignInUrl:j,afterSignUpUrl:I,signInForceRedirectUrl:P,signUpForceRedirectUrl:A,signInFallbackRedirectUrl:L,signUpFallbackRedirectUrl:M,clerkJSUrl:F,clerkJSVersion:K,telemetry:{disabled:D,debug:T}};return s.createElement(re,{options:g},s.createElement(m,{routerPush:p=>{var l;return(l=c.current)==null?void 0:l.call(c,p)},routerReplace:p=>{var l;return(l=c.current)==null?void 0:l.call(c,p,{replace:!0})},initialState:u,sdkMetadata:oe,...g,...d},r))}var ne=({children:r,loaderData:t,...o})=>{let n;const a=y();return!a&&t?.clerkState&&(n=t.clerkState),typeof a<"u"&&a&&ee(o.publishableKey),s.createElement(ae,{...o,clerkState:n},r)};const se="/assets/index-Cqjqzq_K.css",_e=()=>[{rel:"stylesheet",href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap"},{rel:"stylesheet",href:se},{rel:"manifest",href:"/manifest.json"},{rel:"icon",href:"/favicon.ico",type:"image/x-icon"}],ke=()=>[{title:"Studio Platform"},{name:"viewport",content:"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"},{name:"theme-color",content:"#18181B"},{name:"mobile-web-app-capable",content:"yes"},{name:"apple-mobile-web-app-status-bar-style",content:"black-translucent"}],ye=B(function(){const t=Y();return V.useEffect(()=>{"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(o=>{for(const n of o)n.unregister(),console.log("SW unregistered")})},[]),e.jsx(ne,{loaderData:t,signUpFallbackRedirectUrl:"/",signInFallbackRedirectUrl:"/dashboard",children:e.jsx(z,{defaultTheme:"system",storageKey:"studio-theme",children:e.jsxs("html",{lang:"en",children:[e.jsxs("head",{children:[e.jsx("meta",{charSet:"utf-8"}),e.jsx(f,{}),e.jsx(h,{}),t?.env?.VITE_GA_ID&&e.jsxs(e.Fragment,{children:[e.jsx("script",{async:!0,src:`https://www.googletagmanager.com/gtag/js?id=${t.env.VITE_GA_ID}`}),e.jsx("script",{dangerouslySetInnerHTML:{__html:`
                        ...
                        `}})]}),e.jsxs("body",{className:"min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans antialiased selection:bg-blue-100 dark:selection:bg-blue-900",children:[e.jsx(q,{}),e.jsx(J,{}),e.jsx(v,{})]})]})})})}),we=N(function(){const t=W();return console.error(t),e.jsxs("html",{lang:"en",children:[e.jsxs("head",{children:[e.jsx("title",{children:"Oh no!"}),e.jsx(f,{}),e.jsx(h,{})]}),e.jsxs("body",{style:{padding:"20px",fontFamily:"system-ui"},children:[e.jsx("h1",{children:"App Error"}),e.jsx("pre",{children:t instanceof Error?t.message:JSON.stringify(t)}),e.jsx(v,{})]})]})});export{we as ErrorBoundary,ye as default,_e as links,ke as meta};
