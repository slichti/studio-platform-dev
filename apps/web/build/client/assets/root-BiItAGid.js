import{R as n,a as T,j as B,w as N,m as Y,d as $,r as J,M as g,n as h,O as W,S as z,o as v,p as H}from"./chunk-JMJ3UQ3L-Dzyq37y6.js";import{j as r}from"./jsx-runtime-u17CrQMm.js";import{T as V}from"./ThemeProvider-8YW7RrVS.js";import{C as f}from"./index-C2s7eqQZ.js";import"./chunk-VMBS36YX-BOUZMeWc.js";import"./chunk-OT5FTIRN-DBwNzrXh.js";import"./index-CsedX6-y.js";import"./index-D9_Tf6xB.js";import"./runtimeEnvironment-BB2sO-19-DQnzQjGy.js";import"./chunk-6WD75OPE-DjozthMx.js";import"./index-BcCtgopx.js";var i=e=>`🔒 Clerk: ${e.trim()}
...
${Q}
`);function X(e){(!e||!e.__internal_clerk_state)&&console.warn(_)}function Z(e){if(!e)throw new Error(_);if(e&&!e.__internal_clerk_state)throw new Error(q)}function ee(e){if(!e||typeof e!="string")throw new Error(G)}var y=()=>{var e;if(typeof window<"u"&&typeof((e=window.__reactRouterContext)==null?void 0:e.isSpaMode)<"u")return window.__reactRouterContext.isSpaMode},b=n.createContext(void 0);b.displayName="ClerkReactRouterOptionsCtx";var re=e=>{const{children:t,options:o}=e;return n.createElement(b.Provider,{value:{value:o}},t)},te=()=>{const e=T(),t=B(),o=n.useRef([]),s=()=>{o.current.forEach(a=>a()),o.current.splice(0,o.current.length)};return n.useEffect(()=>{s()},[t]),(a,d)=>new Promise(u=>{o.current.push(u),e(a,d)})},oe={name:"@clerk/react-router",version:"2.3.7"},c={current:void 0};function ae({children:e,...t}){const o=te(),s=y();n.useEffect(()=>{c.current=o},[o]);const{clerkState:a,...d}=t;f.displayName="ReactClerkProvider",typeof s<"u"&&!s&&Z(a);const{__clerk_ssr_state:u,__publishableKey:x,__proxyUrl:w,__domain:R,__isSatellite:S,__clerk_debug:U,__signInUrl:E,__signUpUrl:C,__afterSignInUrl:P,__afterSignUpUrl:A,__signInForceRedirectUrl:j,__signUpForceRedirectUrl:I,__signInFallbackRedirectUrl:M,__signUpFallbackRedirectUrl:L,__clerkJSUrl:F,__clerkJSVersion:K,__telemetryDisabled:O,__telemetryDebug:D}=a?.__internal_clerk_state||{};n.useEffect(()=>{typeof s<"u"&&!s&&X(a)},[]),n.useEffect(()=>{window.__clerk_debug=U},[]);const m={publishableKey:x,proxyUrl:w,domain:R,isSatellite:S,signInUrl:E,signUpUrl:C,afterSignInUrl:P,afterSignUpUrl:A,signInForceRedirectUrl:j,signUpForceRedirectUrl:I,signInFallbackRedirectUrl:M,signUpFallbackRedirectUrl:L,clerkJSUrl:F,clerkJSVersion:K,telemetry:{disabled:O,debug:D}};return n.createElement(re,{options:m},n.createElement(f,{routerPush:p=>{var l;return(l=c.current)==null?void 0:l.call(c,p)},routerReplace:p=>{var l;return(l=c.current)==null?void 0:l.call(c,p,{replace:!0})},initialState:u,sdkMetadata:oe,...m,...d},e))}var se=({children:e,loaderData:t,...o})=>{let s;const a=y();return!a&&t?.clerkState&&(s=t.clerkState),typeof a<"u"&&a&&ee(o.publishableKey),n.createElement(ae,{...o,clerkState:s},e)};const ne="/assets/index-C2BHccAA.css",ke=()=>[{rel:"stylesheet",href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap"},{rel:"stylesheet",href:ne},{rel:"manifest",href:"/manifest.json"},{rel:"icon",href:"/favicon.ico",type:"image/x-icon"}],_e=()=>[{title:"Studio Platform"},{name:"viewport",content:"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"},{name:"theme-color",content:"#18181B"},{name:"mobile-web-app-capable",content:"yes"},{name:"apple-mobile-web-app-status-bar-style",content:"black-translucent"}],ye=N(function(){const t=$();return J.useEffect(()=>{"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(o=>{for(const s of o)s.unregister(),console.log("SW unregistered")})},[]),r.jsx(se,{loaderData:t,signUpFallbackRedirectUrl:"/",signInFallbackRedirectUrl:"/dashboard",children:r.jsx(V,{defaultTheme:"system",storageKey:"studio-theme",children:r.jsxs("html",{lang:"en",children:[r.jsxs("head",{children:[r.jsx("meta",{charSet:"utf-8"}),r.jsx(g,{}),r.jsx(h,{}),r.jsx("script",{dangerouslySetInnerHTML:{__html:`
