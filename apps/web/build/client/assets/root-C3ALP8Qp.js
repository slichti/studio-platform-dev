import{b as O,j as $,w as B,k as N,u as W,M as f,o as h,O as Y,S as J,p as v,l as V}from"./chunk-EPOLDU6W-CxxYD-cd.js";import{j as e}from"./vendor-puck-aUaaDwmz.js";import{R as n,a as H}from"./vendor-livekit-D3VpklN2.js";import{T as z}from"./ThemeProvider-udq0vqIR.js";import{T as G}from"./index-BFgzoDOP.js";import{C as m}from"./index-BbFx4P7B.js";import"./chunk-VMBS36YX-Dx-IGLGE.js";import"./chunk-OT5FTIRN-BoMpxN7p.js";import"./index-DYRzKbRc.js";import"./index-7UaQKl4K.js";import"./chunk-6WD75OPE-CbkFdZFq.js";var i=r=>`🔒 Clerk: ${r.trim()}
...
`);function Z(r){(!r||!r.__internal_clerk_state)&&console.warn(y)}function ee(r){if(!r)throw new Error(y);if(r&&!r.__internal_clerk_state)throw new Error(q)}function re(r){if(!r||typeof r!="string")throw new Error(Q)}var k=()=>{var r;if(typeof window<"u"&&typeof((r=window.__reactRouterContext)==null?void 0:r.isSpaMode)<"u")return window.__reactRouterContext.isSpaMode},w=n.createContext(void 0);w.displayName="ClerkReactRouterOptionsCtx";var te=r=>{const{children:t,options:o}=r;return n.createElement(w.Provider,{value:{value:o}},t)},oe=()=>{const r=O(),t=$(),o=n.useRef([]),s=()=>{o.current.forEach(a=>a()),o.current.splice(0,o.current.length)};return n.useEffect(()=>{s()},[t]),(a,d)=>new Promise(u=>{o.current.push(u),r(a,d)})},ae={name:"@clerk/react-router",version:"2.3.9"},c={current:void 0};function se({children:r,...t}){const o=oe(),s=k();n.useEffect(()=>{c.current=o},[o]);const{clerkState:a,...d}=t;m.displayName="ReactClerkProvider",typeof s<"u"&&!s&&ee(a);const{__clerk_ssr_state:u,__publishableKey:x,__proxyUrl:b,__domain:R,__isSatellite:S,__clerk_debug:E,__signInUrl:U,__signUpUrl:C,__afterSignInUrl:j,__afterSignUpUrl:I,__signInForceRedirectUrl:P,__signUpForceRedirectUrl:A,__signInFallbackRedirectUrl:L,__signUpFallbackRedirectUrl:M,__clerkJSUrl:F,__clerkJSVersion:T,__telemetryDisabled:K,__telemetryDebug:D}=a?.__internal_clerk_state||{};n.useEffect(()=>{typeof s<"u"&&!s&&Z(a)},[]),n.useEffect(()=>{window.__clerk_debug=E},[]);const g={publishableKey:x,proxyUrl:b,domain:R,isSatellite:S,signInUrl:U,signUpUrl:C,afterSignInUrl:j,afterSignUpUrl:I,signInForceRedirectUrl:P,signUpForceRedirectUrl:A,signInFallbackRedirectUrl:L,signUpFallbackRedirectUrl:M,clerkJSUrl:F,clerkJSVersion:T,telemetry:{disabled:K,debug:D}};return n.createElement(te,{options:g},n.createElement(m,{routerPush:p=>{var l;return(l=c.current)==null?void 0:l.call(c,p)},routerReplace:p=>{var l;return(l=c.current)==null?void 0:l.call(c,p,{replace:!0})},initialState:u,sdkMetadata:ae,...g,...d},r))}var ne=({children:r,loaderData:t,...o})=>{let s;const a=k();return!a&&t?.clerkState&&(s=t.clerkState),typeof a<"u"&&a&&re(o.publishableKey),n.createElement(se,{...o,clerkState:s},r)};const ie="/assets/index-gf66O_WJ.css",ye=()=>[{rel:"stylesheet",href:"https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap"},{rel:"stylesheet",href:ie},{rel:"manifest",href:"/manifest.json"},{rel:"icon",href:"/favicon.ico",type:"image/x-icon"}],ke=()=>[{title:"Studio Platform"},{name:"viewport",content:"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"},{name:"theme-color",content:"#18181B"},{name:"mobile-web-app-capable",content:"yes"},{name:"apple-mobile-web-app-status-bar-style",content:"black-translucent"}],we=B(function(){const t=W();return H.useEffect(()=>{"serviceWorker"in navigator&&navigator.serviceWorker.getRegistrations().then(o=>{for(const s of o)s.unregister(),console.log("SW unregistered")})},[]),e.jsx(ne,{loaderData:t,signUpFallbackRedirectUrl:"/",signInFallbackRedirectUrl:"/dashboard",children:e.jsx(z,{defaultTheme:"light",storageKey:"studio-theme",children:e.jsxs("html",{lang:"en",suppressHydrationWarning:!0,children:[e.jsxs("head",{children:[e.jsx("meta",{charSet:"utf-8"}),e.jsx(f,{}),e.jsx(h,{}),t?.env?.VITE_GA_ID&&e.jsxs(e.Fragment,{children:[e.jsx("script",{async:!0,src:`https://www.googletagmanager.com/gtag/js?id=${t.env.VITE_GA_ID}`}),e.jsx("script",{dangerouslySetInnerHTML:{__html:`
                        ...
                        `}})]}),e.jsxs("body",{className:"min-h-screen bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 font-sans antialiased selection:bg-blue-100 dark:selection:bg-blue-900",suppressHydrationWarning:!0,children:[e.jsx(Y,{}),e.jsx(G,{position:"top-right",richColors:!0}),e.jsx(J,{}),e.jsx(v,{})]})]})})})}),xe=N(function(){const t=V();return console.error(t),e.jsxs("html",{lang:"en",children:[e.jsxs("head",{children:[e.jsx("title",{children:"Oh no!"}),e.jsx(f,{}),e.jsx(h,{})]}),e.jsxs("body",{style:{padding:"20px",fontFamily:"system-ui"},children:[e.jsx("h1",{children:"App Error"}),e.jsx("pre",{children:t instanceof Error?t.message:JSON.stringify(t)}),e.jsx(v,{})]})]})});export{xe as ErrorBoundary,we as default,ye as links,ke as meta};
