...
app.post('/', async (c) => {
    ...
    const createClassSchema = z.object({
        ...
        autoCancelThresholdHours: z.number().int().optional(),
    });
    ...
    const { title, description, startTime, durationMinutes, capacity, locationId, createZoomMeeting, price, currency, thumbnailUrl, recurrenceRule, recurrenceEnd, isRecurring, autoCancelEnabled, autoCancelThresholdHours } = parseResult.data;
