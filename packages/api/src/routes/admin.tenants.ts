...
app.delete('/:id', async (c) => {
    ...
    try {
        ...
        await db.delete(communityReactions).where(inArray(communityReactions.postId, db.select({ id: communityPosts.id }).from(communityPosts).where(eq(communityPosts.tenantId, tid)))).run().catch(() => { });
