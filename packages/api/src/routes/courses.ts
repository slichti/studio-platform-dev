...
const CourseSchema = z.object({
    ...
    overlayTitle: z.string().nullable().optional(),
    overlaySubtitle: z.string().nullable().optional(),
    price: z.number(),
...
app.openapi(createRoute({
    ...
    const tenant = c.get('tenant');
    if (!c.get('can')('manage_courses')) return c.json({ error: 'Unauthorized' }, 403 as any);
    ...
    const newCourse = {
        ...
        overlayTitle: body.overlayTitle ?? null,
        overlaySubtitle: body.overlaySubtitle ?? null,
        price: body.price,
