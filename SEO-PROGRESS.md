...
| Task ID | Component | Description | Status |
|---|---|---|---|
| T2.1 | GBP OAuth | Implement 'Connect to Google' flow for tenants | Pending |
| T2.2 | NAP Sync | Automate business hour and location updates to Google Maps | Pending |
| T2.3 | Indexing Queue| Build Cloudflare Queue for Google Indexing API submissions | Pending |
| T2.4 | Schema Factory| Automate LocalBusiness and Event schema generation | Pending |
| T2.5 | Review Engine | Trigger Google Review prompts via class check-in data | Pending |
...
| Task ID | Component | Description | Status |
|---|---|---|---|
| T3.1 | AI Meta-Gen | Integrate AI for unique tenant descriptions and alt-text | Pending |
| T3.2 | Video/LMS Schema| Implement `isAccessibleForFree` and VideoObject automation | Pending |
| T3.3 | Review AI | Generate draft responses for Google Reviews using tenant context | Pending |
| T3.4 | Local Pages | Programmatic generation of neighborhood-specific landing pages | Pending |
| T3.5 | SEO Dashboard | Tenant-facing ranking and visibility metrics (via SE Ranking API) | Pending |
