...
*   **Community Hub**: A studio-wide engagement platform with **Isolated Topics** (e.g., # Nature, # Yoga Tips). Supports **Eligibility Rules** (auto-granting topic access based on course enrollment or membership tier) and **Hidden Topics**. Includes **Isolated Feeds** where topic-specific posts stay within their context, **AI-Powered Writing Assistance** (Gemini AI), and a premium post management UI with editing, deletion, and topic migration support.
